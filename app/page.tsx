    ...
    <main className="min-h-screen bg-neutral-950 px-6 py-12 md:px-12 lg:px-20">
      <header className="mb-20">
        ...
        <p className="mt-3 text-lg text-neutral-500">
          The best books I've read each year. <a href="https://www.brandonbellero.com/posts/building-a-digital-bookshelf" className="underline hover:text-neutral-300">Learn more</a>.
        </p>
      </header>
